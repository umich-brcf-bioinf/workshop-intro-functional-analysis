---
title: "Intro to Functional Analysis  : Advanced setup instructions"
...
1.2 Click "Download R for Windows" (the latest version is fine). Open the 
    downloaded executable to launch the R installer.
...
1.5 Click on **Download RStudio Desktop for Windows**. Open the
    ...
    prompt you to login as an Admin user or (if your current account has Admin 
    privileges) simply ask you to allow it to make changes. Click **Yes**
...
1.8  Following the workshop, you can remove R and
...
- one at a time, copy the blocks of code below and paste into the RStudio 
      **Console** tab
- make sure the block you just pasted is highlighted and press **Enter/Return** 
      to execute.
...
BiocManager::install(bioconductor_packages, update=FALSE, ask=FALSE)
...
2.2 Press **Control-Q** close RStudio; when prompted to *Save workspace
