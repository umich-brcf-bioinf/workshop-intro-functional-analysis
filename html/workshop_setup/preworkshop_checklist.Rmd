...
output:
        html_document:
            theme: paper
            includes:
                in_header: workshop_setup_header.html
            toc: false
...
1. (optional) Take the [Pre-workshop survey](https://michmed.org/w4RnW){target="_blank"}<br/>
...
4. If you have not taken a workshop with us recently, we recommend you review a brief [orientation on how we will be using Zoom/Slack](https://www.mivideo.it.umich.edu/media/t/1_dqou12ko).
