...
To create a Project, click <kbd>File</kbd> then <kbd>New Project...</kbd>. In the New Project Wizard window that opens, select <kbd>Existing Directory</kbd>, then <kbd>Browse...</kbd>. In the Choose Directory window, select the `IFUN_R` folder by clicking it once, and then click the <kbd>Choose</kbd> button. Finally, click <kbd>Create Project</kbd>.

Once we do this, RStudio will restart and the Files pane (lower right) should put us in the `~/IFUN_R` folder where there is an `inputs/` folder and an `IFUN_R.Rproj` file.
...
<img src="images/content/03-WebGestalt_R/03_rstudio_console_execution.png" alt="rstudio console execution" style="width:1000px;"/>
...
<img src="images/content/03-WebGestalt_R/06_rstudio_script_execution.png" alt="rstudio script execution" style="width:1000px;"/>
...
<img src="images/content/03-WebGestalt_R/07_rstudio_soft_wrap.png" alt="rstudio code execution" style="width:1000px;"/>
...
```{r rsd_kegg_ora, warning = FALSE, message = FALSE}
# -------------------------------------------------------------------------
...
<br/>
<hr/>
| [Previous lesson](02-IntroToWebGestaltandORA.html) | [Top of this lesson](#top) | [Next lesson](07A-advanced-visualizations.html) |
| :--- | :----: | ---: |