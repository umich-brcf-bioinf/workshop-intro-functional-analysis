...
<!--![RStudio Server - testing ](images/content/03-WebGestalt_R/02_rstudio_session_default.png)-->
...
Commands can also be run in a script. Some benefits to using a script rather than relying on the Console pane:
