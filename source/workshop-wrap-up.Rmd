...
![](images/wayfinder/wayfinder-wrap-up.png)

---

Functional analysis matches observed expression patterns against a library of 
known biological gene sets. Adding this biological context connects observed 
patterns with the research question. 
...
- Please take our optional [post-workshop survey](https://michmed.org/eQVm3){target="_blank"} (5-10 minutes).
