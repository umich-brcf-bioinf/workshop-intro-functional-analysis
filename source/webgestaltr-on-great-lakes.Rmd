---
title: "Running WebGestaltR on UMich Great Lakes HPC"
...
![](images/great-lakes-ood/great-lakes-wayfinder.png)

## Objectives
You can run WebGestaltR and several related R libraries using 
...
![](images/great-lakes-ood/great-lakes-wayfinder-ood.png)
...
3. In the menu at the top of the screen, click **Interactive Apps** and select 
   **RStudio**. ![](images/great-lakes-ood/ood-interactive-apps.png)

4. The previous step will display a _launch configuration page_ with several fields, e.g.
       ![partial screen shot](images/great-lakes-ood/ood-launch-config.png)
    ...
...
5. After you've entered the values above, at the bottom of this page click **Launch**. 
   ...
   ![](images/great-lakes-ood/ood-queue-rstudio.png){width=50%}

6. When the session is ready (usually a few seconds later), the screen will update:
   ![](images/great-lakes-ood/ood-launch-rstudio.png){width=50%}
...
![](images/great-lakes-ood/rstudio-startup.png)

8. You may see a prompt asking permission to use the clipboard. Click **Allow**.
![](images/great-lakes-ood/clipboard-permission.png){width=25%}
...
|:-:|:-:|
| ![](images/great-lakes-ood/browser-edge-clipboard-setting.png) | ![](images/great-lakes-ood/browser-chrome-clipboard-setting.png) |
...
![](images/great-lakes-ood/great-lakes-wayfinder-worker-node.png)
...
- Running RStudio in the browser inside the Great Lakes HPC complicates copying 
  ...
  - Copy and paste _mostly_ work as expected using Chrome or Edge browsers. 
    ...
    ![](images/great-lakes-ood/novnc-controls.png){width=25%}
    - Select the clipboard icon.
    ![](images/great-lakes-ood/novnc-controlpanel.png){width=25%}
    - Copy text into the clipboard area; within that area, use the native 
      ...
      control panel.
      ![](images/great-lakes-ood/novnc-clipboard.png)
    - Right-click (or _control V_) to paste the contents into the console.
    ![](images/great-lakes-ood/novnc-paste.png){width=50%}
...
- FYI, you can launch the Firefox browser by clicking on Applications (top left) | 
  ...
  ![](images/great-lakes-ood/ood-browser.png){width=50%}
...
Any of the following actions will end your session:
  ...
  ![](images/great-lakes-ood/rstudio-close.png){width=25%}
  ...
  ![](images/great-lakes-ood/ood-delete.png){width=50%}
...
TODO:cgates: fix the download dump dir listing
...
![](images/great-lakes-ood/great-lakes-file-transfer.png)
...
1.3 To view a plot graphic, you can click on the hamburger and then select **View**.
    ...
    ![](images/great-lakes-ood/ood-files-view.png)
1.4 You can download one or more files by selecting their checkboxes and 
    ...
    **Download**, OOD will download the contents as a single zipped file.)
    ![](images/great-lakes-ood/ood-files-download.png)
...
![](images/great-lakes-ood/great-lakes-wayfinder-shell.png)
...
3. In the menu at the top of the screen, click **Interactive Apps** and select 
   **Basic Desktop**. ![](images/great-lakes-ood/ood-interactive-apps-basic-desktop.png)

4. The previous step will display a _launch configuration page_ with several fields, e.g.
   ![partial screen shot](images/great-lakes-ood/ood-launch-config-basic-desktop.png)
    ...
...
5. After you've entered the launch config values, at the bottom of this page click **Launch**. 
   ...
   preparing your session. 
   ![](images/great-lakes-ood/ood-queue-basic-desktop.png){width=50%}

6. When the session is ready (usually a few seconds later), the screen will update:
   ![](images/great-lakes-ood/ood-launch-basic-desktop.png){width=50%}
    - Drag the Compression slider all the way to the right
    - Drag Image Quality slider all the way to the right
...
![](images/great-lakes-ood/basic-desktop-startup.png)

8. This creates a new **Terminal Window** in your Basic Desktop.
![](images/great-lakes-ood/basic-desktop-terminal.png)
...
- Any of the following actions will end your session:
  ...
  - In [Open OnDemand session page](https://greatlakes.arc-ts.umich.edu/pun/sys/dashboard/batch_connect/sessions){target="_blank"}, click **Delete**.
  ![](images/great-lakes-ood/ood-basic-desktop-delete.png){width=50%}
...
5. Scroll to the bottom and click the checkbox **Save settings**. This will 
   ...
   click **Save**.
  ![](images/great-lakes-ood/ood-template-name.png){width=50%}
6. Now click **Save settings and close**.<br/>
   ![](images/great-lakes-ood/ood-template-save-settings-and-close.png){width=50%}
...
![](images/great-lakes-ood/ood-template-saved-settings.png)
...
![](images/great-lakes-ood/great-lakes-wayfinder-summary.png)
