...
deficient.v.control_bulkDE <- read_csv("inputs/bulk_de_results/de_deficient_vs_control_annotated.csv")
...
write(deficient_DE_GeneList, file ="results/deficient_DE_GeneList.txt", ncolumns = 1)
write(deficient_background_GeneList, file ="results/deficient_background_GeneList.txt", ncolumns = 1)
