...
<!-- Add screenshot of the top of the WebGestalt homepage -->
...
<!-- Add screenshot of the bottom of the WebGestalt homepage -->


## WebGestalt documentation

A good practice when using a new tool is to read the documentation provided by the developers. 

## WebGestalt analysis demonstration

<!-- load & runcd - demo data -->
...
def_v_cont_bulkDE <- read_csv("DE_results_deficient_vs_control_annotated.csv")
