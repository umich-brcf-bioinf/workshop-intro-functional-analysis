...
![WebGestalt homepage top]("source/images/content/02-WebGestalt_topOfPage.png")
...
![WebGestalt homepage inputs]("source/images/content/02-WebGestalt_topOfPage.png")  


## WebGestalt documentation

![WebGestalt homepage find manual]("source/images/content/02-webgestalt_ClickManual.png")  
...
![WebGestalt homepage manual top]("source/images/content/02-webgestalt_TopOfManual.png")  
...
![WebGestalt homepage manual page 2]("source/images/content/02-webgestalt_Manual2ndPage.png")
...
deficient.v.control_bulkDE <- read_csv("../data/de_deficient_vs_control_annotated.csv") #TO REVISE - path will need to be adjusted
...
deficient_DE_only <- deficient.v.control_bulkDE %>%
  filter(padj < 0.5 & abs(log2FoldChange) > log2(1.5))
...
![WebGestalt submit data for ORA]("source/images/content/WebGestalt_bulkRNA_screenshots/02-bulkRNA_a_submission_error.png")  
